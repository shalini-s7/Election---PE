...
export default function ElectoBot({ fullPage = false }) {
  ...
  const getResponse = (question) => {
    ...
    if (q.includes('myth') || q.includes('fact check') || q.includes('fake')) return 'Have you heard something and want to know if it\'s true? Check out the new **[Myth Buster Mode](/modes/myth-buster)** to separate fact from fiction!';
